...
class OrdenServiceImplTest {
    ...
    void productoValido_retornaPrecio() {
        ...
        OrdenServiceImpl target = AopTestUtils.getTargetObject(ordenService);
        BigDecimal precio = ReflectionTestUtils.invokeMethod(target, "obtenerPrecioProducto", 1L);
    ...
    void productoNoExiste_lanzaResourceNotFoundException() {
        ...
        assertThrows(ResourceNotFoundException.class, () ->
                ReflectionTestUtils.invokeMethod(target, "obtenerPrecioProducto", 1L));
    }
