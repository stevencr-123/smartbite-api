...
import com.smartbite.operativo.dto.orden.EstadoOrdenRequestDTO;
...
public class OrdenController {
    ...
    public ResponseEntity<OrdenResponseDTO> obtenerOrdenPorId(
        ...
        return ResponseEntity.ok(
                ordenService.obtenerOrdenPorId(
                        id
                )
        );
    }
    ...
    public ResponseEntity<List<OrdenResumenDTO>> listarOrdenes() {
        ...
        return ResponseEntity.ok(
                ordenService.obtenerOrdenesActivas()
        );
    }
    ...
    public ResponseEntity<OrdenResponseDTO> cerrarOrden(
            @PathVariable Long id
    ) {

        return ResponseEntity.ok(
                ordenService.cerrarOrden(
                        id
                )
        );
    }
